                            ...
                            <div class="demo-card-square mdl-card mdl-shadow--2dp full-width">
                                ...
                                <div class="mdl-card__supporting-text">
                                    ...
                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                        <input class="mdl-textfield__input" name="batch_name" type="text" id="sample3">
                                        <label class="mdl-textfield__label" for="sample3">batch_name</label>
                                        </div><br>
                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                        <input class="mdl-textfield__input" name="course_name" type="int" id="sample4">
                                        <label class="mdl-textfield__label" for="sample4">course_name</label>
                                        </div>
                                </div>
