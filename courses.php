...
$query_select_courses = "SELECT c.id, course_name, years_to_complete, faculty_name 
                           FROM courses c 
                     INNER JOIN faculties f
                             ON c.faculty_id = f.id";
$result_select_courses = mysqli_query($link, $query_select_courses) or dir(mysqli_error($link));
?>
<html>
    <head>
        <title>Courses</title>
                     ...
                     <div class="actions">
                        ...
                        <table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp full-width">
                            ...
                            <tbody>
                                ...
                                <?php while ($row = mysqli_fetch_array($result_select_courses)) { ?>
                                    <tr>
