...
$query_select_faculty = "SELECT id, faculty_name FROM faculties";
                    ...
                    <div class="page-wrapper">
                        ...
                        <div class="actions">
                            <a href="add_faculty.php">
                                <button class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored"> Add faculty </button>
                            </a>
                        </div>
                        ...
                        <table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp full-width">
                            ...
                            <tbody>
                                ...
                                <?php while ($row = mysqli_fetch_array($result_select_faculty)) { ?>
                                    <tr>
